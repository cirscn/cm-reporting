...
- 47322a7: 自定义冶炼厂整行内容使用主题错误色标红，兼容宿主自定义 Ant Design CSS 变量前缀，并在禁用及只读状态下保持红色显示；示例明确区分库内置标红与宿主附加行样式规则。

## 0.10.0

### Minor Changes

- 3c72653: 新增 CMRT 6.6.1、EMRT 2.11.1、AMRT 1.31.1 三个官方无 Logo 版本，保留独立版本号与官方文件名用于快照和 Excel 导出溯源，并保持对应旧版本的结构、字段与校验规则不变。
